...
#define MSG_SD_INSERTED                     _UxGT("Картку вставлено")
#define MSG_SD_REMOVED                      _UxGT("Картку видалено")
...
#define MSG_LEVEL_BED_HOMING                _UxGT("Парковка XYZ")
#define MSG_LEVEL_BED_WAITING               _UxGT("Почати")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Наст. точка")
...
#define MSG_PREHEAT_1                       _UxGT("Нагрів PETG")
...
#define MSG_MOVE_01MM                       _UxGT("Рух по 0.1мм")
#define MSG_MOVE_1MM                        _UxGT("Рух по 1мм")
#define MSG_MOVE_10MM                       _UxGT("Рух по 10мм")
...
#define MSG_FILAMENT_DIAM                   _UxGT("Діам. пласт.")
...
#define MSG_PREPARE                         _UxGT("Підготовка")
